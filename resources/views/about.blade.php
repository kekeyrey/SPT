...
<body>
  ...
  <header class="about-hero">
    <nav class="navbar">
      ...
      <ul class="nav-links">
        ...
        <li><a class="active" href="#">ABOUT SPT</a></li>
  ...
  <div class="breadcrumb">
    <a href="homenon" class="btn">Home</a>/ <span>Our Product</span></p>
  </div>
